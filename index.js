...
//Realiza conecção com o banco e realiza o teste de conexão 
...
//primeiro parametro é a rota e o segundo uma função anonima com requisição e resposta 
...
app.post("/usuarios", (req, res) => {
    try {
        ...
        client.query(
            ...
            (err, result) => {
            if (err) {
                res.status(408).json("Parametros incorretos.")
...
//Ele ira escutar as portas , precisa ser a ultima função da api
app.get("/", (req, res) => {
